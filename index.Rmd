...
`r paste0("<div class='my-footer'><span>", params$event, "</span> <center><div class=logo><img src='https://raw.githubusercontent.com/ArthurSrz/images/main/Screenshot%202021-05-19%20at%2016.04.37.png' width='40px'></center></span></div>")` 

---

class: center, middle

Ces slides en ligne : `r paste0("https://arthursrz.github.io/", params$slug)`

Sources : `r paste0("https://github.com/ArthurSrz/", params$slug)`
...
---
## Contexte : le projet européen INTERREG DEAS 

[![](https://raw.githubusercontent.com/ArthurSrz/images/main/DEAS_TUBA%CC%80_training%20OD%20200521.001.jpeg)](https://www.alpine-space.eu/projects/deas/en/home)

---
## Le partenariat européen : INTERREG DEAS

#### Objectifs :

- Valoriser l'utilisation de l'open data pour les services publics et les entreprises.
- Augmenter la compétitivité de la région "Alpine" grace à l'exploitation de l'open data dans 3 domaines clés: l'environnement, le tourisme & la culture, la mobilité.
- Les 12 porteurs du projet souhaitent accélerer la création de services innovants et centrés usagers (habitants, touristes, entrepreneurs) grâce notamment à :
- Une plateforme commune DEAS, type api.gouv.fr
- Une méthodologie d'utilisation de l'open data, nourrie de méthodes locales comme l’Open Data Canvas
- Des pilotes locaux et transnationaux pour créer de nouveaux services.

--- 
## Le partenariat européen : INTERREG DEAS

[![](https://raw.githubusercontent.com/ArthurSrz/images/main/Screenshot%202021-05-19%20at%2007.03.24.png)](https://www.alpine-space.eu/projects/deas/en/home)
...
# .red[Data Training]
## Créer son application de recherche de financement grâce à l'open data

---

## WhatTheSub
[Une application ](https://whatthesub.glideapp.io/) pour optimiser la recherche de financements publics grâce à l'open data

.center.reduite[![](https://raw.githubusercontent.com/ArthurSrz/images/main/Screenshot%202021-05-19%20at%2007.36.03.png)]


---
## Au programme

- Equiper sa forge de données : de quoi ai-je besoin pour créer cette application
- Définir l'usage avant de penser à la data
- Récupérer les données ouvertes sur les dispositifs de financements publics
- Façonner la donnée à l'image de l'usage 
- Créer une interface applicative pour naviguer au sein des données
- Penser l'ajout et la curation de données 
- Intégrer les données 
- Valider le parcours utilisateur de l'applications
...
- [votre base de gestion des demandes de fonds publics](https://airtable.com/shrRrF52DGlZQixu4)
- [la base aides-entreprises.fr mise en open data](https://data.aides-entreprises.fr/)

*...et 2 outils logiciels*

- [Workbench Data](https://workbenchdata.com/) - Outil de manipulation de données gratuit
- [Glide](https://www.glideapps.com/) - Outil gratuit de création d'application à partir d'un ou plusieurs jeux de données
...
.center[![](https://media.giphy.com/media/YWAiayVul0JLq/giphy.gif)]

Cette application servira à tout chef de structure/gestionnaire qui souhaite pouvoir suivre ses demandes de financements comme il suit ses (futurs) client : **avec un tableau de suivi ou CRM.**

---

## Récupérer les données ouvertes sur les dispositifs de financements publics

- Les données, sont ici sous la forme de [plusieurs fichiers .csv...](https://data.aides-entreprises.fr/stock)

- ...et sont accompagnées d'[une documentation](https://data.aides-entreprises.fr/documentation) (pour les comprendre)

---

## Façonner la donnée à l'image de l'usage 

.pull-right[![](https://media.giphy.com/media/3jiLt1aBGfF37ZmK8a/giphy.gif)]
.pull-left[- améliorer leur lisibilité...pour les comprendre
- compiler les données...pour **révéler l'information utile à l'usage**
- mettre au format de votre jeu de donnée interne

[**Processus de façonnage**](https://app.workbenchdata.com/workflows/144005)]

---

## Créer une interface applicative pour naviguer au sein des données

[3 espaces](https://whatthesub.glideapp.io/ss)...: 
- 1 espace pour **visualiser tous les financements disponibles**
- 1 espace pour **centraliser les contacts**
- 1 espace pour **suivre les financements actifs**

.center[![](https://raw.githubusercontent.com/ArthurSrz/images/main/Screenshot%202021-05-19%20at%2014.21.34.png)]

...et des connecteurs (dits champs liés) pour assurer la navigation

---

## Penser l'ajout et la curation de données 

.center[![](https://media.giphy.com/media/UsB4hCkBUeKfqZ1Jl3/giphy.gif)]

---

## Intégrer les données 

.center[![](https://media.giphy.com/media/MQ4bWOjn8C9tT2dzIb/giphy.gif)]

---

## Valider le parcours utilisateur de l'application

.center[![](https://media.giphy.com/media/OmK8lulOMQ9XO/giphy.gif)]
...
Contact : [arthur@datactivi.st](mailto:arthur@datactivi.st)
